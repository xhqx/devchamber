export const settingsDict = {
  ...
  'settings.behavior.page.responseStyle.customInstructions': 'Custom response instructions',
  'settings.behavior.page.responseStyle.visualInstructions': 'Visual formatting instructions',
  'settings.behavior.page.responseStyle.visualPlaceholder': 'Describe how visual mode should format answers: canvas blocks, diagrams, tables, timelines, wireframes...',
  'settings.behavior.page.responseStyle.resetVisual': 'Reset visual instructions to default',
  ...
  'settings.behavior.page.responseStyle.option.visual': 'Tekst + wizualnie',
