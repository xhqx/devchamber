...
const UPDATE_CHECK_URL = process.env.OPENCHAMBER_UPDATE_API_URL || 'https://api.devchamber.dev/v1/update/check';
const GITHUB_BACKEND_DISABLED_ERROR = 'DevChamber VS Code backend GitHub integration is disabled. Use native VS Code GitHub integrations.';
