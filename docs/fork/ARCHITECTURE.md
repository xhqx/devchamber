...
- `packages/ui/src/lib/changeExplanations/*` — pure schema, store, code-change detection, and structured explanation generation helpers for IDE explanations and docs-required decisions.
